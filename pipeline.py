...
def run_transcription_pipeline(
    ...
    corrected_stage = _correction_stage(transcript_for_correction or raw_transcript, domain_mode=domain_mode)

    validation = validate_transcript_detailed(corrected_stage.data, domain_mode=domain_mode)
    errors = []
...
def _correction_stage(transcript, domain_mode="meeting") -> StageResult:
    try:
        corrected = correct_text(transcript, domain_mode=domain_mode)
    except Exception as exc:
